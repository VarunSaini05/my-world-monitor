    ...
    setTrustedHtml(this.ctx.container, trustedHtml(`
      ...
      <div class="header">
        ...
        return `
          ...
          <span class="logo">VARUN MONITOR</span><span class="logo-mobile">Varun World Monitor</span><span class="version">v${__APP_VERSION__}</span>${BETA_MODE ? '<span class="beta-badge">BETA</span>' : ''}
          <a href="https://github.com/VarunSaini05" target="_blank" rel="noopener" class="credit-link">
            <svg class="x-logo" width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
            <span class="credit-text">@VarunSaini05</span>
          </a>
          <a href="https://github.com/VarunSaini05/my-world-monitor" target="_blank" rel="noopener" class="github-link" title="${t('header.viewOnGitHub')}">
      ...
      <nav class="mobile-menu" id="mobileMenu">
        <div class="mobile-menu-header">
          <span class="mobile-menu-title">VARUN WORLD MONITOR</span>
        ...
        <a class="mobile-menu-item" href="https://github.com/VarunSaini05" target="_blank" rel="noopener">
          ...
          <span class="mobile-menu-item-label">@VarunSaini05</span>
        </a>
        <div class="mobile-menu-divider"></div>
        <div class="mobile-menu-footer-links">
          <a href="https://varun-world-monitor.onrender.com" target="_blank" rel="noopener">Web</a>
          <a href="https://github.com/VarunSaini05/my-world-monitor" target="_blank" rel="noopener">GitHub</a>
        </div>
      ...
      <footer class="site-footer">
        <div class="site-footer-brand">
          ...
          <div class="site-footer-brand-text">
            <span class="site-footer-name">VARUN WORLD MONITOR</span>
            <span class="site-footer-sub">v${__APP_VERSION__} &middot; <a href="https://github.com/VarunSaini05" target="_blank" rel="noopener" class="site-footer-credit">Varun Saini</a></span>
          </div>
        </div>
        <nav>
          <a href="https://varun-world-monitor.onrender.com" target="_blank" rel="noopener">Web</a>
          <a href="https://github.com/VarunSaini05/my-world-monitor" target="_blank" rel="noopener">GitHub</a>
          <a href="https://github.com/VarunSaini05" target="_blank" rel="noopener">Maintainer</a>
          ${this.ctx.isDesktopApp ? '' : `<span id="footerDownloadMount"></span>`}
        </nav>
        <span class="site-footer-copy">&copy; ${new Date().getFullYear()} Varun World Monitor</span>
      </footer>
