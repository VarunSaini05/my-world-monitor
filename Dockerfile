...
# This image is the private/self-hosted distribution. The public hosted build
# does not use this Dockerfile and therefore keeps normal entitlement checks.
ENV VITE_SELF_HOSTED_FULL_ACCESS=true
