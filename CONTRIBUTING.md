...
Use the [Bug Report issue template](https://github.com/VarunSaini05/my-world-monitor/issues/new/choose) when available.
...
Use the [Feature Request issue template](https://github.com/VarunSaini05/my-world-monitor/issues/new/choose) when available.
